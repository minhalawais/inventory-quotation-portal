                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-lg font-semibold text-secondary">{quotation.rider.name}</p>
                      </div>
                    </div>
                    ...
                    {quotation.rider.phone && (
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-lg font-semibold text-secondary">{quotation.rider.phone}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {quotation.rider.email && (
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-lg font-semibold text-secondary break-words">{quotation.rider.email}</p>
                        </div>
                      </div>
                    )}
                  </div>
